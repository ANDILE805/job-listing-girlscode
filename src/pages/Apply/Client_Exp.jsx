        ...
        <div className="container mx-auto">
          <form action = "http://localhost:5000/client_profile/{client_id}/experience" method="post" className="border-4 rounded py-4 px-3" >
            ...
            <div className="mt-3">
              ...
              <input type="text" name="company_name" placeholder="Enter your company name" className="block w-full border-2 bg-blue-200 p-2 rounded" required />
            </div>
            <div className="mt-3">
              <label htmlFor="joblocationcity" className="font-bold">Job Location City</label>
              <input type="location" name="job_location_city" placeholder="Job Location City" className="block w-full border-2 bg-blue-200 p-2 rounded" required />
            </div>
            <div className="mt-3">
              <label htmlFor="joblocationstate" className="font-bold">Job Location State</label>
              <input type="location" name="job_location_state" placeholder="Job Location State" className="block w-full border-2 bg-blue-200 p-2 rounded" required />
            </div>
            <div className="mt-3">
              <label htmlFor="joblocationcountry" className="font-bold">Job Location Country</label>
              <input type="location" name="job_location_country" placeholder="Job Location Country" className="block w-full border-2 bg-blue-200 p-2 rounded" required />
            </div>
            <div className="mt-3">
              <label htmlFor="description" className="font-bold">What were your duties?</label>
              <input type="location" name="description" placeholder="Job Description" className="block w-full border-2 bg-blue-200 p-2 rounded" required />
            </div>
